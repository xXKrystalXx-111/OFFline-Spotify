...
// Alias to the Android-generated Resource class to avoid ambiguity with MAUI Resource types
using AndroidResource = global::OFFline_Spotify.Resource;
    ...
    public class AudioPlayerService : Service
    {
        ...
        private Notification BuildNotification()
        {
            ...
            return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                // Use the Android Resource alias and the mipmap resource that MAUI generates for the app icon.
                // If your generated resource lives under Drawable instead of Mipmap, change Mipmap -> Drawable.
                .SetSmallIcon(AndroidResource.Mipmap.appicon_round)
